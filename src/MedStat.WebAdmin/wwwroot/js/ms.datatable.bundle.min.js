 ...
 */
window.ms=window.ms||{};window.ms.DataTableToolsClass=function(){function n(n,r){var f,u;switch(n.name){case"data-ms-html-template":return f=$(n.value).html(),t(f,r);case"data-ms-max-length":return u=parseInt(n.value),u!==NaN?i(u,r):null;default:return null}}function t(n,t){var r,i;return n!=null&&n!=""&&(r=/\{(.*?)\}/g,i=n.match(r),i!=null&&i.length>0)?{targets:t,render:function(t,r,u){for(var o,e=n+"",f=0;f<i.length;f++)o=i[f].replace("{","").replace("}",""),e=e.replace(i[f],u[o]);return e}}:null}function i(n,t){return{targets:t,render:function(t,i){return i==="display"&&t!=null&&t.length>n?'<span title="'+t+'">'+t.substr(0,n)+"...<\/span>":t}}}function r(t){for(var u,r,f,e={columnDefs:[]},o=$(t).find("th"),i=0;i<o.length;i++)for(u=o[i].attributes,r=0;r<u.length;r++)if(f=n(u[r],i),f!=null){e.columnDefs.push(f);break}return e}function u(n){var t={};return $.each(n.attributes,function(n,i){switch(i.name){case"data-ms-page-length-control":$(i.value).each(function(){var n=parseInt(this.value);n!=null&&(t.pageLength=n,t.dom=t.dom!=null?t.dom:$.fn.dataTable.defaults.dom,t.dom=t.dom.replace("l>",">"))});break;case"data-ms-search-control":$(i.value).each(function(){t.dom=t.dom!=null?t.dom:$.fn.dataTable.defaults.dom;t.dom=t.dom.replace("f>",">")})}}),t}function f(n){$.each(n.table().node().attributes,function(t,i){switch(i.name){case"data-ms-page-length-control":$(i.value).change(function(){n.page.len(parseInt(this.value)).draw()});break;case"data-ms-search-control":$(i.value).on("keyup",function(){n.search(this.value).draw()})}})}this.preProcessCustomAttributes=function(n){var t=r(n),i=u(n);return $.extend(t,i)};this.postProcessCustomAttributes=function(n){f(n)}},function(n){n.fn.msDataTable=function(t){var i=this;return this.each(function(){var i=this,r=new window.ms.DataTableToolsClass,u={processing:!0,serverSide:!0,lengthMenu:[10,25,50],pagingType:"first_last_numbers",language:window.msDataTableOptions!=null?window.msDataTableOptions.language:null},f=r.preProcessCustomAttributes(i),e=n.extend(u,f,t||{}),o=n(i).DataTable(e);r.postProcessCustomAttributes(o)}),i}}(jQuery);window.setTimeout(function(){var n=$("table[ms-datatable]");n.length>0&&n.msDataTable()},50);